          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-white sm:max-w-xs sm:mx-0 sm:text-left">
                Turn your YouTube videos into SEO-friendly blogs with
                BlabberBlog. Automatically transcribe, summarize, and optimize
                your content for better visibility. Boost your online presence
                with AI-powered blogging made easy!
              </p>
